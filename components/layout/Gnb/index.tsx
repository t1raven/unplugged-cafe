      ...
      <div id="site-gnb">
        <nav ref={gnbRef}>
          <ul>
            ...
            <li className={pathname.startsWith('/goods') ? "active" : ""}><Link href="/goods" title="굿즈"><span className="icon material-symbols-rounded" translate="no">apparel</span><span className="text">앨범 · 굿즈</span></Link></li>
