...
import loageImage from '@/public/images/common/site-logo-bk.png';
  ...
  return (
    <header id="site-header">
      <div className="inner">
        <div className="logo">
          <Link href="/">
            <Image src={loageImage} alt="UNPLUGGED LOUNGE" />
          </Link>
        </div>
        <div className="gnb-btn">
          ...
          <Link href="#">
            <span className="material-symbols-rounded">dark_mode</span></Link>
        </div>
      </div>
    </header>
  );
